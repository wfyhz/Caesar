    ...
    var methods = {
        init: function (attributes, options) {
            return this.each(function () {
                ...
                //set ajax submit url
                if(settings.enableAjaxSubmit){
                    settings.ajaxSubmitUrl = settings.ajaxSubmitUrl===undefined ? $form.attr('action') : settings.ajaxSubmitUrl;
                }
                    ...
                    $.ajax({
                        ...
                        success: function (msgs) {
                            if (msgs !== null && typeof msgs === 'object') {
                                ...
                                console.log($.extend(messages, msgs));
        ...
        submitForm: function () {
            ...
            if (data.validated) {
                ...
                //alert(this.enableAjaxSubmit);
                if(data.settings.enableAjaxSubmit)
                {

                    $.ajax({
                        url:data.settings.ajaxSubmitUrl,
                        type: $form.attr('method'),
                        data: $form.serialize(),
                        dataType: data.settings.ajaxDataType,
                        //complete: function (jqXHR, textStatus) {
                        ...
                        success: function (d) {
                            ...
                            {//失败
                                ...
                                updateInputs($form, $.extend(messages, msg), data.submitting);
                            }
                            else
                            {
                                alert('success')
