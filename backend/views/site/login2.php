...
<div class="login-wrap">
	<div class="container login-container">
		...
		<!-- <div class="row">
			<?php //$form->field($model, 'verifyCode',['enableLabel'=>false, 'options'=>['class'=>'col-sm-4 ']])
				//->textInput(['placeholder'=>$model->getAttributeLabel('verifyCode')]) 
				?>
			<?php//p $form->field($model, 'verifyCode',['enableLabel'=>false, 'options'=>['class'=>'col-sm-5'],'enableError'=>false])
